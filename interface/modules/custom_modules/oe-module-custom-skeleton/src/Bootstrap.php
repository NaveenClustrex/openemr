...
class Bootstrap
{
    ...
    const MODULE_NAME = "Patient-import-module-custom-skeleton";
    /**
    ...
    public function addCustomModuleMenuItem(MenuEvent $event)
    {
        ...
        $menuItem->label = xlt("Import Patient");
        ...
        $menuItem->url = "/interface/modules/custom_modules/oe-module-custom-skeleton/public/index.php";
        $menuItem->children = [];
